...
public class Client implements PageTurner {
    ...
    public void nextPage() {
        ...
        switch (pageNumber) {
            case 1:
                lineDrawerPage(StarburstLineTest::new);
                break;
            case 2:
                lineDrawerPage(ParallelogramTest::new);
                break;
            case 3:
                lineDrawerPage(RandomLineTest::new);
                break;
            case 4:
                polygonDrawerPage(panels);
                break;
            case 0:
                polygonDrawerPage(ghostPanels);        // will be fifth page.  5 == 0 (mod 5)
                break;
            default:
                defaultPage();
                break;
